...
const Sidebar = () => {
  ...
  return (
    <div className="w-1/5 min-h-screen p-4 bg-gray-100 border-r border-gray-300 fixed">
      <div className="mb-4">
                ...
                <div className="mt-2">
                    {productTypes.map(type=>(
                        <label key={type.id} className="mt-2 flex items-center">
                            <input type="checkbox" className="mr-2" checked={type.checked} onChange={()=>handleChecked(type.id)} />
